...
// --------------
// 0. Make relative paths behave like in transform.ts
// --------------
...
const usage = () => {
  console.log(`
Usage:
  npm run transform:rotterdam -- <cdf_input_folder> <fhir_output_folder>

Example:
  npm run transform:rotterdam -- data/cdf_rotterdam data/fhir_rotterdam
`);
};
...
async function main() {
  ...
  // Make relative paths behave like in transform.ts
  resolveLocalPath();
  ...
  for (const file of files) {
    ...
    // Use Rotterdam-specific helper functions
