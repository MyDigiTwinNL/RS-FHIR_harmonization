 ...
 */
const hasIncidentHF = (wave) => {
    const flag = (0, functionsCatalog_1.inputValue)('inc_hf_2018', wave);
    if (flag === undefined)
        return false;
 ...
 */
const incidentHFDate = (wave) => {
    if (!hasIncidentHF(wave))
        return undefined;
    const raw = (0, functionsCatalog_1.inputValue)('enddat_hf', wave);
    if (!raw || raw.trim() === '')
        return undefined;
