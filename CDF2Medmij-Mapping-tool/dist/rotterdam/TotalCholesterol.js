...
const totalCholResults = function (wave) {
    const totalCholRes = (0, functionsCatalog_1.inputValue)('TC_mmol', wave);
...
const isTotalCholAboveReferenceRange = function (wave) {
    ...
    if (totalChol === undefined)
        return undefined;
    return totalChol > (0, exports.referenceRangeUpperLimit)();
};
/**
 ...
 */
const assessmentMissed = function (wave) {
