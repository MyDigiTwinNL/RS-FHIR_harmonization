...
exports.heartFailure = {
    conditionName: function () {
        return 'heart-failure';
    },
    isPresent: function () {
        return _clinicalStatus((0, functionsCatalog_1.inputValue)("heartfailure_presence_adu_q_1", "1a"), (0, functionsCatalog_1.inputValues)("heartfailure_followup_adu_q_1")) === (0, codesCollection_1.getSNOMEDCode)("55561003");
    },
    /* Related variables:
    * ------------------------------------------------------------------
    *                                [1A][1B][1C][2A][3A][3B]
    ...
    */
    clinicalStatus: function () {
        return _clinicalStatus((0, functionsCatalog_1.inputValue)("heartfailure_presence_adu_q_1", "1a"), (0, functionsCatalog_1.inputValues)("heartfailure_followup_adu_q_1"));
    },
    /**
     *
     * Related variables:
    ...
    onsetDateTime: function () {
        ...
        if ((0, functionsCatalog_1.inputValue)("heartfailure_presence_adu_q_1", "1a") === '1') {
            const surveyDateParts = firstAssessmentDate.split("-");
            const surveyYear = Number(surveyDateParts[0]);
            const heartfailureStartAge = (0, functionsCatalog_1.inputValue)("heartfailure_startage_adu_q_1", "1a");
     ...
     */
    code: function () {
        return (0, codesCollection_1.getSNOMEDCode)("84114007");
    },
};
/**
 * Memoized function for clinicalStatus
 */
const _clinicalStatus = (0, moize_1.default)((heartfailure_presence, followup_assessments) => {
 ...
 * @returns
 */
function findDatesBetweenheartfailurePresenceReport() {
    const heartfailureFollowUp = (0, functionsCatalog_1.inputValues)('heartfailure_followup_adu_q_1');
    ...
    (0, unexpectedInputException_1.assertIsDefined)(heartfailureWave, `A 'yes' value on heartfailure_followup_adu_q_1 was expected`);
    const heartfailureWaveDate = (0, functionsCatalog_1.inputValue)("date", heartfailureWave);
    ...
    if (heartfailureWaveDate === undefined) {
        ...
        (0, unexpectedInputException_1.assertIsDefined)(previousAssessmentWave, `Assessment (with a non-null date) expected to exist previous to the one where heartfailure_followup_adu_q_1 is reported`);
        const previousAssessmentDate = assessmentDates[previousAssessmentWave];
        return [previousAssessmentDate, heartfailureWaveDate];
    }
}
//# sourceMappingURL=HeartFailure.js.map