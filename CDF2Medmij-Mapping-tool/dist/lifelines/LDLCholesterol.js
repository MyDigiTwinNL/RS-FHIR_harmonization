...
const isLDLAboveReferenceRange = function (wave) {
    if (ldlResults(wave) != undefined) {
        return Number((0, functionsCatalog_1.inputValue)("ldlchol_result_all_m_1", wave)) > (0, exports.referenceRangeUpperLimit)();
    }
    else {
        return undefined;
    }
...
const ldlResults = function (wave) {
    const ldlres = (0, functionsCatalog_1.inputValue)("ldlchol_result_all_m_1", wave);
    if (ldlres != undefined) {
