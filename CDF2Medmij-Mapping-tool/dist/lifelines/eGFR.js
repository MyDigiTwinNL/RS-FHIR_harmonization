...
exports.eGFRS = {
    ...
    diagnosticCodeCoding: function () {
        ...
        return [(0, codesCollection_1.getLOINCCode)('62238-1')];
    },
...
const eGFRResult = (wave) => {
    ...
    //4:asian
    //5:other:
    const race = (0, functionsCatalog_1.inputValue)("ethnicity_category_adu_q_1", '1b');
    ...
    if (gender === undefined || race === undefined || creatinine === undefined || age === undefined) {
        ...
        (0, unexpectedInputException_1.assertIsDefined)((0, functionsCatalog_1.inputValue)("date", "1a"), `Precondition failed: date of baseline assessment (1a) is expected to be not-null for eGFR calculations`);
        ...
        const monthsSinceBaseline = (0, lifelinesFunctions_1.substractDates)((0, functionsCatalog_1.inputValue)("date", "1a"), (0, functionsCatalog_1.inputValue)("date", wave));
 ...
 * @returns
 */
const resultFlags = function (wave, limit) {
