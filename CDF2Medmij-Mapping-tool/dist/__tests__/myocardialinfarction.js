...
const MyocardialInfarction_1 = require("../lifelines/MyocardialInfarction");
...
test('heartattack, when reported positive in 1A', () => {
    ...
    expect(MyocardialInfarction_1.myocardialInfarction.clinicalStatus()?.display).toBe("Active");
    expect(MyocardialInfarction_1.myocardialInfarction.isPresent()).toBe(true);
    expect(MyocardialInfarction_1.myocardialInfarction.code().display).toBe("Myocardial infarction (disorder)");
    expect(MyocardialInfarction_1.myocardialInfarction.onsetDateTime()).toBe("1982");
});
test('heart attack, when reported in 2A', () => {
    ...
    expect(MyocardialInfarction_1.myocardialInfarction.isPresent()).toBe(true);
    expect(MyocardialInfarction_1.myocardialInfarction.code().display).toBe("Myocardial infarction (disorder)");
    expect(MyocardialInfarction_1.myocardialInfarction.onsetDateTime()).toBe("1999-05");
});
test('heart attack, when reported right after baseline (1B)', () => {
    ...
    expect(MyocardialInfarction_1.myocardialInfarction.isPresent()).toBe(true);
    expect(MyocardialInfarction_1.myocardialInfarction.code().display).toBe("Myocardial infarction (disorder)");
    expect(MyocardialInfarction_1.myocardialInfarction.onsetDateTime()).toBe("1993-05");
});
test('heart attack, when reported on a follow-up assessment, without prividing the date of such assessment', () => {
    ...
    expect(MyocardialInfarction_1.myocardialInfarction.isPresent()).toBe(true);
    expect(MyocardialInfarction_1.myocardialInfarction.code().display).toBe("Myocardial infarction (disorder)");
    expect(MyocardialInfarction_1.myocardialInfarction.onsetDateTime()).toBe(undefined);
});
test('heart attack, when reported in 2A, after skipping one assessment', () => {
    ...
    expect(MyocardialInfarction_1.myocardialInfarction.isPresent()).toBe(true);
    expect(MyocardialInfarction_1.myocardialInfarction.code().display).toBe("Myocardial infarction (disorder)");
    expect(MyocardialInfarction_1.myocardialInfarction.onsetDateTime()).toBe("1998-05");
});
test('heart attack, when reported in 2A, after skipping multiple assessments', () => {
    ...
    expect(MyocardialInfarction_1.myocardialInfarction.isPresent()).toBe(true);
    expect(MyocardialInfarction_1.myocardialInfarction.code().display).toBe("Myocardial infarction (disorder)");
    expect(MyocardialInfarction_1.myocardialInfarction.onsetDateTime()).toBe("1997-05");
});
test('heart attack, when no reported', () => {
    ...
    inputSingleton_1.InputSingleton.getInstance().setInput(input);
    expect(MyocardialInfarction_1.myocardialInfarction.clinicalStatus()).toStrictEqual(undefined);
});
